...
class Jobtablepage extends React.Component{
    render(){
        return(
            ...
            React.createElement('div',{className: "jobtable__menu"},React.createElement('button', {className: "bt__subs bt"},"PEOPLE"), React.createElement('button', {className:"bt_message bt"},"MESSAGE")), React.createElement('div', {className: "jobtable__subs"}),))
        )
    }
}
